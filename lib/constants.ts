...
export const ITEMS: Record<string, Item> = {
  ...
  "canned_food": {
    id: "canned_food",
    name: "통조림",
    description: "유통기한이 조금 지났지만 먹을만해 보입니다.",
    isConsumable: true,
    effect: { sanity: 10, battery: 5 }
  }
};
...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    weight: 3,
    effect: { time: 30, item: "water_bottle" }
  },
  {
  ...
  {
    id: 'search_herbs',
    text: "숲속에서 쓸만해 보이는 약초를 발견했다.",
    weight: 5,
    effect: { time: 20, item: "herbal_medicine" }
  },
  {
    id: 'search_canned',
    text: "모래 속에 파묻힌 통조림을 발견했다.",
    weight: 4,
    effect: { time: 25, item: "canned_food" }
  },

  // --- Useful Events (Weights: 4-6) ---
  {
    id: 'search_hill',
  ...
  },
  {
    ...
    weight: 6,
    effect: { time: 15, sanity: 10, battery: 2 }
  },
  {
  ...
  {
    id: 'search_spring',
    text: "맑은 옹달샘을 발견했다. 목을 축이고 세수를 했다.",
    weight: 5,
    effect: { time: 15, sanity: 10 }
  },
  {
    id: 'search_fire_remains',
    text: "아직 온기가 남은 모닥불 흔적을 발견했다. 누군가 근처에 있다!",
    weight: 4,
    effect: { time: 10, sanity: 5 }
  },

  // --- Useless / Negative Events (Weights: 2-3) ---
  {
    id: 'search_forest',
  ...
  },
  {
    ...
    weight: 3,
    effect: { time: 40, sanity: -10, signal: 2 }
  },
  {
  ...
  // --- Message/Environment Events (Weights: 1-2) ---
  {
    id: 'msg_unknown_1',
  ...
  // --- High Risk / High Reward (Weights: 2) ---
  {
  ...
  // --- Special Endings (Weights: 0.2 - Very Rare) ---
  {
    id: 'ending_boat',
